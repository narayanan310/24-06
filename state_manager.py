...
_DEFAULT_STATE: dict = {
    ...
    "headlights":    False,
    "brightness":       50,
    # Dynamic vehicle context — updated externally (e.g. OBD-II / CAN sensor feed)
    "vehicle_speed":     0,    # km/h; 0 = stationary / unknown
    "is_raining":    False,    # True when rain sensor / weather API reports wet
}
